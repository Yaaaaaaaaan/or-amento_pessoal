...
function cadastrarDespesa(){
	...
	if(despesa.validarDados()){
		...
		document.getElementById('tituloModal').innerHTML = 'Êxito'
		document.getElementById('textoModal').innerHTML='Sucesso! Dados armazenados.'
		...
		document.getElementById('textoModal').innerHTML=' Alguns campos obrigatórios não foram preenchidos corretamente.'
...
function carregaListaDespesas(despesas =Array(), fintro = false){
	if(despesas.length ==0 && fintro == false){
